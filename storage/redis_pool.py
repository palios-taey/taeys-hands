...
if _platform.system() == 'Darwin':
    DEFAULT_HOST = os.environ.get('REDIS_HOST', '10.0.0.68')
else:
    DEFAULT_HOST = os.environ.get('REDIS_HOST', '192.168.100.10')

DEFAULT_PORT = int(os.environ.get('REDIS_PORT', 6379))

# Node identity for key scoping.
# Each machine (spark-78c6, jetson, thor) gets isolated Redis keys.
