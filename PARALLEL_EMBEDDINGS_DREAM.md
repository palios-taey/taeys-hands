...
**Spark #1** (10.x.x.68 / REDACTED_LAN_IP):
- Neo4j Aura: bolt://REDACTED_LAN_IP:7687
- Elasticsearch: http://REDACTED_LAN_IP:9200
- Qwen3-Coder-30B via vLLM: http://REDACTED_LAN_IP:8000 (CORRECTED - code expects 8001)

**Spark #2** (10.x.x.80 / REDACTED_LAN_IP):
- **Weaviate**: http://REDACTED_LAN_IP:8080
- **Qwen3-Embedding-8B via vLLM**: http://REDACTED_LAN_IP:8000
