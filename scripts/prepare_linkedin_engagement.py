...
PRIVATE_ROOT_ENV = 'TAEY_LINKEDIN_ENGAGEMENT_PRIVATE_ROOT'
DRAFT_ENV = 'TAEY_LINKEDIN_ENGAGEMENT_DRAFT'
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description='Prepare one immutable LinkedIn engagement transaction topology.',
    )
