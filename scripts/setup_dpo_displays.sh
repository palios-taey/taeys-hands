...
#
# Creates:
#   :2 → Firefox → chatgpt.com (REDACTED_EMAIL)
#   :3 → Firefox → gemini.google.com (REDACTED_EMAIL)
#   :4 → Firefox → grok.com (REDACTED_EMAIL)
#   :5 → Firefox → claude.ai (REDACTED_EMAIL)
#
# VNC ports: 5902-5905 (password protected)
# Login: cookies copied from active Firefox profile. Use login_bot.py for
#        accounts that need different credentials (Claude = redacted@example.com).
