...
**Location**: `<OPERATOR_HOME>/taeys-hands/mcp_server/`
...
**Features**:
- Logs conversations to Neo4j on mira (10.x.x.163:7687)
...
**Location**: `<OPERATOR_HOME>/taeys-hands/rosetta_stone/`
