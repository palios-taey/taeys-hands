...
EMBODIMENT_CONTEXT = '<OPERATOR_HOME>/the-conductor/sft/embodiment_training_context.md'
EMBODIMENT_SFT_PROMPT = '<OPERATOR_HOME>/the-conductor/sft/sft_embodiment_prompt.md'
EMBODIMENT_DPO_PROMPT = '<OPERATOR_HOME>/the-conductor/sft/dpo_embodiment_prompt.md'
IDENTITY_FILES = {
    'chatgpt': '<OPERATOR_HOME>/data/corpus/identity/IDENTITY_HORIZON.md',
    'claude': '<OPERATOR_HOME>/data/corpus/identity/IDENTITY_CLARITY.md',
    'gemini': '<OPERATOR_HOME>/data/corpus/identity/IDENTITY_COSMOS.md',
    'grok': '<OPERATOR_HOME>/data/corpus/identity/IDENTITY_LOGOS.md',
    'perplexity': '<OPERATOR_HOME>/data/corpus/identity/IDENTITY_CLARITY.md',
}
...
def _build_embodiment_package(platform):
    ...
    for path in [EMBODIMENT_CONTEXT,
                 '<OPERATOR_HOME>/data/corpus/identity/FAMILY_KERNEL.md',
