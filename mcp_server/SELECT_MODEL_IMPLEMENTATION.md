...
## Files Modified
1. `/Users/jesselarose/taey-hands/mcp_server/server-v2.ts`
   - Added tool definition
   - Added request handler

## Files Created
1. `/Users/jesselarose/taey-hands/mcp_server/test-select-model.mjs`
   - Full integration test
2. `/Users/jesselarose/taey-hands/mcp_server/test-select-model-error.mjs`
   - Error handling test
