...
```json
{
  ...
  "interface": "claude",
  "filePaths": [
    "/Users/REDACTED/document1.pdf",
    "/Users/REDACTED/image.png"
  ]
}
```
**Output**:
...
await taey_attach_files({
  ...
  interface: "claude",
  filePaths: [
    "/Users/REDACTED/DNA_ROSETTA_STONE_THEORY.md",
    "/Users/REDACTED/wave_communicator.py"
  ]
});
