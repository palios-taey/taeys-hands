...
AGENT_PROFILES: Dict[str, Dict[str, Any]] = {
    ...
    # --- Conductor's dedicated instances ---
    "conductor-gemini": {
        "name": "Conductor Gemini",
        "cli_type": "gemini",
        "machine": "spark1",
        "role": "worker",
        "worktree_path": "/home/spark/worktrees/conductor-gemini",
        "tmux_session": "conductor-gemini",
        "context_window": 1_000_000,
        "capabilities": [0.80, 0.75, 0.85, 0.30, 0.85],
    },
    "conductor-codex": {
        "name": "Conductor Codex",
        "cli_type": "codex",
        "machine": "spark1",
        "role": "worker",
        "worktree_path": "/home/spark/worktrees/conductor-codex",
        "tmux_session": "conductor-codex",
        "context_window": 128_000,
        "capabilities": [0.70, 0.85, 0.40, 0.50, 0.70],
    },
    # --- Weaver's dedicated instances ---
    "weaver-gemini": {
        "name": "Weaver Gemini",
        "cli_type": "gemini",
        "machine": "spark1",
        "role": "worker",
        "worktree_path": "/home/spark/worktrees/weaver-gemini",
    ...
    "weaver-codex": {
        ...
        "machine": "spark1",
        "role": "worker",
        "worktree_path": "/home/spark/worktrees/weaver-codex",
