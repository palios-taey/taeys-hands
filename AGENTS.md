...
You are a CLI agent in the PALIOS-TAEY fleet on Mira (REDACTED_LAN_IP).
...
|---------|---------|------|
| Spark 1 | `ssh spark@REDACTED_LAN_IP` | Orchestrator, Redis, dashboard |
| Spark 2 | `ssh spark@REDACTED_LAN_IP` | Embedding server |
| Spark 4 | `ssh spark@REDACTED_LAN_IP` | Available |
| Thor | `ssh thor@REDACTED_LAN_IP` | HMM worker |
| Jetson | `ssh jetson@REDACTED_LAN_IP` | Taey inference |

## Network Services
| Service | Endpoint |
|---------|----------|
| ISMA Query API | http://127.0.0.1:8095 |
| Dashboard | http://REDACTED_LAN_IP:5001 |
| Neo4j | bolt://localhost:7687 (neo4j/REDACTED-CRED) |
| Weaviate | http://localhost:8088 |
| Redis | 127.0.0.1:6379 |
| Embedding LB | http://REDACTED_LAN_IP:8091 |
