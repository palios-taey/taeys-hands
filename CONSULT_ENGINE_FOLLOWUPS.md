...
### Task: fu-perplexity-export-markdown-fallback - Add Export-as-Markdown 0-control extract fallback [priority: 20] [owner: taeys-hands-codex] [depends: fu-claude-artifact-extract]
...
### Task: fu-gemini-dr-start-research-send-gap - Fix Gemini DR "Start research" click not firing on send [priority: 20] [owner: taeys-hands-codex] [depends: fu-perplexity-export-markdown-fallback]
