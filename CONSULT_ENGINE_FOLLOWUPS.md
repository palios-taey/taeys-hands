...
### Task: fu-claude-artifact-extract - Map the live Claude right-panel artifact Copy control [priority: 20]
...
### Task: fu-perplexity-export-markdown-fallback - Add Export-as-Markdown 0-control extract fallback [priority: 20]
...
### Task: fu-gemini-profile-aware-element-names - Profile-aware Gemini element names for 2-set parallelism [priority: 30]
...
### Task: fu-routing-parent-pkg-error-translation - Fix routing.py error-translation for a missing PARENT pkg [priority: 40]
...
### Task: fu-osresource-find-firefox-race - Per-package find-Firefox window/bus concurrency assertion [priority: 40]
