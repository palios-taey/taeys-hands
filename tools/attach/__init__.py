...
# Aliases for hmm_bot compatibility (uses underscore-prefixed names)
_keyboard_nav_attach = keyboard_nav_attach
_close_stale_file_dialogs = close_stale_file_dialogs
_get_attach_button_coords = get_attach_button_coords
_any_file_dialog_open = any_file_dialog_open
