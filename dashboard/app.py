...
ISMA_API = os.environ.get("ORCH_ISMA_API", "http://localhost:8095")
...
# Service/node IPs from environment (deployment-specific)
_NCCL_HOST = os.environ.get("ORCH_NCCL_HOST", "localhost")
_WEAVIATE_HOST = os.environ.get("ORCH_WEAVIATE_HOST", "localhost")

SERVICES = [
    {"name": "Redis", "host": os.environ.get("ORCH_REDIS_HOST", _NCCL_HOST), "port": 6379, "type": "tcp"},
    {"name": "Neo4j", "host": os.environ.get("ORCH_NEO4J_HOST", _NCCL_HOST), "port": 7687, "type": "tcp"},
    {"name": "Weaviate", "host": _WEAVIATE_HOST, "port": 8088, "type": "http", "path": "/v1/.well-known/ready"},
    {"name": "ISMA Query API", "host": _NCCL_HOST, "port": 8095, "type": "http", "path": "/health"},
    {"name": "Embedding LB", "host": _NCCL_HOST, "port": 8091, "type": "http", "path": "/health"},
    {"name": "Dashboard", "host": "127.0.0.1", "port": 5001, "type": "self"},
]

NODES = json.loads(os.environ.get("ORCH_NODES_JSON", "[]")) or [
    {"name": "Spark 1", "host": "localhost"},
]
