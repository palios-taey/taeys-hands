...
Usage:
    ...
    python test_phi_vs_baselines.py --weaviate-url http://localhost:8080 --ollama-url http://10.0.0.80:11435
...
def main():
    ...
    # Embedding options
    parser.add_argument("--ollama-url", default="http://10.0.0.80:11435",
