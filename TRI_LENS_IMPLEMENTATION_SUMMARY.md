...
1. **Environment Verification**
   - Check Weaviate (REDACTED_LAN_IP:8080)
...
3. **Repository Deployment**
   - Clone/update builder-taey to `<OPERATOR_HOME>/builder-taey`
...
│  │   Spark #1            │    │   Spark #2            │    │
│  │   10.x.x.68           │    │   10.x.x.80           │    │
│  │   REDACTED_LAN_IP      │    │   REDACTED_LAN_IP      │    │
│  ├───────────────────────┤    ├───────────────────────┤    │
...
cd <OPERATOR_HOME>/builder-taey/databases/scripts
...
```python
import weaviate
client = weaviate.connect_to_local(host='REDACTED_LAN_IP', port=8080)
...
tail -f <OPERATOR_HOME>/logs/vllm-embedding.log
```
...
- Verify network latency: `ping -c 100 REDACTED_LAN_IP`
...
- Check vLLM health: `curl http://REDACTED_LAN_IP:8001/health`
