...
When a response looks like HMM enrichment JSON (contains `{` and "motif"), `extract.py` fires an HTTP POST to `http://REDACTED_LAN_IP:8095/hmm/store-response`. This is:
