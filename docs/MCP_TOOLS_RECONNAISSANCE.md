...
```
/Users/jesselarose/palios-taey-nova/claude-dc-implementation/
...
```python
# From: /Users/jesselarose/palios-taey-nova/computeruse/computer_use_demo_old/models/tool_models.py
...
```python
# From: /Users/jesselarose/palios-taey-nova/computeruse/computer_use_demo_old/tools/registry.py
...
```python
# From: /Users/jesselarose/palios-taey-nova/claude-dc-implementation/palios_ai_os/mcp/mcp_server.py
...
```javascript
// From: /Users/jesselarose/taey-hands/src/interfaces/chat-interface.js
...
**1. Bash Tool** (`/Users/jesselarose/palios-taey-nova/computeruse/computer_use_demo_old/tools/bash.py`)
...
**2. Computer Tool** (`/Users/jesselarose/palios-taey-nova/computeruse/computer_use_demo_old/tools/computer.py`)
- Screenshot capture
...
```javascript
// /Users/jesselarose/taey-hands/src/orchestration/orchestrator.js
...
- **Location**: `/Users/jesselarose/palios-taey-nova/claude-dc-implementation/archive/src/mcp/`
...
```javascript
// /Users/jesselarose/taey-hands/package.json
...
|------|------|---------|--------|
| `/Users/jesselarose/taey-hands/src/index.js` | 256 lines | Main entry point & CLI | Production |
| `/Users/jesselarose/taey-hands/src/orchestration/orchestrator.js` | 230 lines | Cross-AI coordination | Production |
| `/Users/jesselarose/taey-hands/src/interfaces/chat-interface.js` | 47KB | Unified AI UI abstraction | Production |
| `/Users/jesselarose/palios-taey-nova/claude-dc-implementation/palios_ai_os/mcp/mcp_server.py` | 20KB | Pattern-based MCP routing | Production |
| `/Users/jesselarose/palios-taey-nova/computeruse/computer_use_demo_old/tools/registry.py` | 248 lines | Tool registration system | Production |
| `/Users/jesselarose/palios-taey-nova/computeruse/computer_use_demo_old/tools/bash.py` | 388 lines | Secure bash execution | Production |
| `/Users/jesselarose/palios-taey-nova/computeruse/computer_use_demo_old/tools/computer.py` | 300+ lines | GUI automation | Production |
| `/Users/jesselarose/taey-hands/config/default.json` | 66 lines | Interface config & selectors | Configuration |
| `/Users/jesselarose/palios-taey-nova/claude-dc-implementation/test_mcp_communication.py` | 100+ lines | Integration tests | Testing |

### Archive/Reference Files

| File | Purpose |
|------|---------|
| `/Users/jesselarose/palios-taey-nova/claude-dc-implementation/archive/src/mcp/mcp_server.py` | FastAPI MCP v1 (reference) |
| `/Users/jesselarose/palios-taey-nova/claude-dc-implementation/archive/src/mcp/mcp_client.py` | MCP client reference |
| `/Users/jesselarose/palios-taey-nova/claude-dc-implementation/archive/src/dashboard/dashboard_mcp_connector.py` | Dashboard integration |
