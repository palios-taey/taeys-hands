...
- Neo4j database accessible at `bolt://10.x.x.163:7687` (or configured URL)
...
export NEO4J_URL="bolt://10.x.x.163:7687"
...
```json
{
  "mcpServers": {
    "taey-hands": {
      ...
      "env": {
        "NEO4J_URL": "bolt://10.x.x.163:7687"
      }
    }
  }
}
...
# Should only show localhost or private IP (10.x.x.163)
```
