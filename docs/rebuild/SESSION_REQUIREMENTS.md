...
### Key Files
- `/Users/jesselarose/taey-hands/mcp_server/server-v2.ts` - MCP tool handlers
- `/Users/jesselarose/taey-hands/mcp_server/session-manager.ts` - Session registry
- `/Users/jesselarose/taey-hands/src/interfaces/chat-interface.js` - Browser automation
- `/Users/jesselarose/taey-hands/src/core/conversation-store.js` - Neo4j persistence
- `/Users/jesselarose/taey-hands/check-sessions-before-connect.mjs` - Database inspection
