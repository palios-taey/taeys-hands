...
**Repository**: /Users/REDACTED/taey-hands
...
- **Main File**: `/Users/REDACTED/taey-hands/mcp_server/server.ts` (287 lines)
...
- **Main File**: `/Users/REDACTED/taey-hands/mcp_server/server-v2.ts` (685 lines)
...
### /Users/REDACTED/taey-hands/mcp_server/package.json
```json
{
...
### /Users/REDACTED/taey-hands/mcp_server/tsconfig.json
```json
{
  "compilerOptions": {
    "target": "ES2022",
...
### /Users/REDACTED/taey-hands/config/default.json
...
```json
{
  "mcpServers": {
    "taey-hands": {
      ...
      "env": {
        "NODE_PATH": "/Users/REDACTED/taey-hands/src"
      }
    }
  }
}
...
2. Start Chrome with debugging:
   ...
   /Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome \
     ...
     --user-data-dir=/Users/REDACTED/Library/Application\ Support/Google/Chrome
   ```
...
### Must Read First
- `/Users/REDACTED/taey-hands/mcp_server/server-v2.ts` - Main MCP implementation
- `/Users/REDACTED/taey-hands/src/interfaces/chat-interface.js` - Core logic
- `/Users/REDACTED/taey-hands/README.md` - Setup instructions

### For Understanding Tools
- `/Users/REDACTED/taey-hands/docs/AI_INTERFACES.md` - Selector reference
- `/Users/REDACTED/taey-hands/config/default.json` - Configuration

### For Testing
- `/Users/REDACTED/taey-hands/mcp_server/test-init.js` - Server test
- `/Users/REDACTED/taey-hands/experiments/test-verified-flow.mjs` - Integration test

### For Debugging
- `/Users/REDACTED/taey-hands/src/core/response-detection.js` - Response parsing
- `/Users/REDACTED/taey-hands/src/core/osascript-bridge.js` - Input automation
