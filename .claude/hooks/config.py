...
ENVIRONMENTS = {
    'spark': {
        'name': 'DGX Spark',
        'redis_host': '192.168.100.10',  # NCCL fabric
        'redis_port': 6379,
        'neo4j_uri': 'bolt://10.0.0.163:7689',  # Mira
        'neo4j_auth': None,
        'agent_id': 'spark',
    ...
    'ccm': {
        'name': 'Mac CCM',
        'redis_host': '10.0.0.68',  # Management network
        'redis_port': 6379,
    ...
    'unknown': {
        ...
        'redis_host': '10.0.0.68',  # Default to management
        'redis_port': 6379,
        'neo4j_uri': 'bolt://10.0.0.68:7689',
        'neo4j_auth': None,
        'agent_id': 'unknown',
...
HOSTNAME_PATTERNS = {
    'spark': ['spark-78c6', 'spark-155d', 'spark-e4b2', 'spark-cf52'],
    'ccm': ['CCM', 'ccm', 'Mac', 'mac'],
}
