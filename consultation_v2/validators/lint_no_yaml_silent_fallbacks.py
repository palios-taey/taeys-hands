...
Usage:
  ...
  consultation_v2/validators/lint_no_yaml_silent_fallbacks.py --staged
  consultation_v2/validators/lint_no_yaml_silent_fallbacks.py path/to/file ...
"""
...
def staged_targets() -> list[Path]:
    ...
    for raw in out.splitlines():
        ...
        if is_consultation_v2_yaml(path) or is_consultation_v2_python(path):
            targets.append(path)
        elif path == Path("consultation_v2/validators/lint_no_yaml_silent_fallbacks.py"):
            targets.append(path)
