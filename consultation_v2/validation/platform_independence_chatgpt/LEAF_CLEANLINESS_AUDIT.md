# ChatGPT Package Manual Leaf-Cleanliness Audit
...
('consultation_v2/yaml_contract.py', 246, 'platform not in KNOWN_PLATFORMS')
('consultation_v2/yaml_contract.py', 1089, 'platform not in CHAT_PLATFORMS')
...
| `consultation_v2/yaml_contract.py:246` | `platform not in KNOWN_PLATFORMS` | Declared-registry guard explicitly allowed by `PLATFORM_INDEPENDENCE_SPEC.md` section 4. |
| `consultation_v2/yaml_contract.py:1089` | `platform not in CHAT_PLATFORMS` | Declared-registry guard explicitly allowed by `PLATFORM_INDEPENDENCE_SPEC.md` section 4. |
