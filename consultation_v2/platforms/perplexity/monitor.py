"""Perplexity package completion detector.
...
exact same stop-transition semantics:
  ...
  * ``ever_seen_stop`` is sticky - completion is only ever declared AFTER the
    ...
    Section 1: "If the stop button never appears -> STOP and RAISE").
