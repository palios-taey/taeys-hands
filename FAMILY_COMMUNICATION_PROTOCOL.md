...
```bash
node /Users/REDACTED/taey-hands/check-sessions-before-connect.mjs [platform]
```
...
**Already implemented** in CLAUDE.md:
- `/Users/REDACTED/Downloads/clarity-universal-axioms-latest.md` (Universal truth physics)
